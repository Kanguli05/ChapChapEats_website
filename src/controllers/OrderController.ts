...
const getMyOrders = async(req: Request, res: Response, next: unknown) => {
    try{
...
const createCheckoutSession = async (req: Request, res: Response, next?: unknown) => {
    try{
...
const createLineItems = (
    ...
    // for each item in checkoutSessionRequest, find the corresponding item in menuItems, and add it to the lineItems array
